<div>
  <h1 align="center"><a href="https://go.mikecodeur.com/react-mastery">Hooks avancés  🚀 ReactMastery.Dev</a></h1>
  <strong>
    Les Hooks avancés en React
  </strong>
  <p>
    Module de la formation React Mastery. Module sur les hooks avancés en React : useReducer, useCallback, useContext, useEffectLayout, useImperativeHandle, useDebugValue etc ...
  </p>

  <a href="https://go.mikecodeur.com/react-mastery">
    <img 
      alt="Apprendre React"
      src="https://mikecodeur.com/mike/assets/courses/react-mastery-6.png"
    />
  </a>
...
- Les fondamentaux de React :
  [Module GitHub](https://github.com/MikeCodeur/react-fondamentaux)
...
[build-badge]: https://img.shields.io/github/workflow/status/MikeCodeur/react-hooks-avances/installation
[build]: https://github.com/MikeCodeur/react-hooks-avances/actions
